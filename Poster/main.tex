...
\newlength{\twocolwid}
\newlength{\threecolwid}
\setlength{\paperwidth}{127.44cm} % A0 width: 46.8in
\setlength{\paperheight}{90.72cm} % A0 height: 33.1in
...
\author{\textit{Group 733 - Alejandro Alonso García, Amalie Vistoft Petersen, Andrea Victoria Tram Løvemærke,\\ Niels Skov Vestergaard, Noelia Villarmarzo Arruñada}} % Author(s)
...
\vspace{.2cm}
\parbox{.98\textwidth}{
Henrik Schiøler, Associate Professor, Aalborg University.
}\vspace{.275cm}
\end{alertblock}
