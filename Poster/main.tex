...
\institute{	School of Comunication and Information Technology - Department of Control and Automation\\
	Email: [aalons16] [apet13] [alavem13] [nveste12] [nvilla16] @student.aau.dk} % Institution(s)

\addtobeamertemplate{headline}{} 
{
	\begin{tikzpicture}[remember picture,overlay] 
	\node [shift={(-15 cm,-9cm)}] at (current page.north east) {\includegraphics[height=11cm]{figures/aau_logo_cropped}}; 
	\end{tikzpicture} 
	\begin{tikzpicture}[remember picture,overlay] 
	\node [shift={(15 cm,-9cm)}] at (current page.north west) {\includegraphics[height=11cm]{figures/aau_logo_cropped}}; 
	\end{tikzpicture} 
}
%----------------------------------------------------------------------------------------
...
%	CONTROL SOLUTION
%----------------------------------------------------------------------------------------
\begin{alertblock}{Control Solution}
