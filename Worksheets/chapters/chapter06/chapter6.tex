...
\fxnote{The network should be described, not only when explaining what should be in the chapter, but explained why it is in the figure, like we have done with everything else in the figure.}
