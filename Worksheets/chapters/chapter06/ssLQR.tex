In order to find the values of the feedback matrix, a Linear Quadratic Regulator (LQR) is utilized. and Bryson's rule in order to find the optimal control and having the possibility of prioritizing the convergence of the different states while setting boundaries to the control action applied to the system. 
