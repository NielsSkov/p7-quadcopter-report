...
\subsubsection{Data}
The data which is transmitted from the computer to the micro controller, is the attitude (roll, pitch and yaw), the position (x, y and z) and the translational velocity ($\dot{x}$, $\dot{y}$ and $\dot{z}$). 
...
\multicolumn{1}{|l|}{14}   & \multicolumn{1}{l|}{112} & \multicolumn{10}{c|}{$\dot{x}$}                                                                                                                                                                                                                         & \multicolumn{6}{l|}{$\dot{y}$}                                                                                                                            \\ \hline
\multicolumn{1}{|l|}{16}   & \multicolumn{1}{l|}{128} & \multicolumn{5}{l|}{}                                                                                                      & \multicolumn{11}{l|}{$\dot{z}$}                                                                                                                                                                                                                                                        \\ \hline
