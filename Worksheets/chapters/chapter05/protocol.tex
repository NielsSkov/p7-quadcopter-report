...
The start sequence constitutes the header of the package and it is necessary for the micro controller to be able to distinguish between transmitted packets and arbitrary data. %As the microcontroller receives packages from the computer, a queue of packages are stored on the micro controller along with the generated noise.
