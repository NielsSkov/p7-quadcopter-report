...
The translational velocity ($\dot{x}$, $\dot{y}$ and $\dot{z}$) is contained in 11 bits, with the first bit assigned to be a sign bit. Yielding a possibility of transmitting a value between 1024 and minus 1024. This yields a maximum velocity of about 10 \si{m \cdot s^{-1}}, which is deemed sufficient.
