...
This initial prototype description serves as a basis for requirements given in \autoref{ch:functionalRequirements}, after which the model is derived in \autoref{chap:Model}.

\fxnote{Look through this section and ensure it is correct.}

\fxnote{write somewhere, that we would like to disregard incorrect packets.}

\fxnote{write somewhere that we would like to quadcopter to be able to move in the x, y and z direction.}
