...
%
\subsection{Battery}
The battery available for the prototype, is a Turnigy battery. It has a capacity of \SI{2200}{mAh}, a voltage of \SI{11.1}{V} and a discharge rate of 20-30 C.\cite{HKingBattery}\fxnote{change soruce}
%
\begin{figure}[H]
	\centering
	\includegraphics[scale=1.3]{figures/rd.jpg}
	\caption{The battery mounted on the quadcopter.\cite{HKingBattery} \fxnote{change source}}
	\label{fig:battery}
\end{figure}
%%
...
\begin{figure}[H]
	...
	\caption{User interface of the Vicon System, the Vicon Tracker. An object has been created from the markers placed on the quadcopter.\fxnote{change picture}}
