...
The quadcopter is equipped with four brushless outrunner motors named Turing Multistar. 

This kind or motors have the magnets in the outer shell, spinning them around the fixed coils in the center. Due to this feature, they normally have more poles that inrunner ones, being able to produce more torque with the same size. 
