...
\begin{figure}[H]
	...
	\captionbox
	{
		User interface of the Vicon System, the Vicon Tracker. An object has been created from the markers placed on the quadcopter.\fxnote{change picture}.
  ...
  \captionbox
  {
  	An illustration showing the Vicon system's cameras sensing the quadcopter, and the network between the ground station and the quadcopter. \fxnote{change to vicon and remove lightning}
