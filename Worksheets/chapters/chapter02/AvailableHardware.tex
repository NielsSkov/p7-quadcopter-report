...
The provided quadcopter framework has the dimensions 45 cm from rotor to rotor and is an X-shaped symmetric quadcopter and has a height of 7.5 cm. With the provided and selected hardware the total mass of the quadcopter is 0.996 kg.
