...
%
\begin{where}
\va{R_X}{is the matrix describing a rotation around the $x_\mathrm{B}$ axis}{1}
\va{R_Y}{is the matrix describing a rotation around the $y_\mathrm{B}$ axis}{1}
\va{R_Z}{is the matrix describing a rotation around the $z_\mathrm{B}$ axis}{1}
\va{R}{is the total rotation matrix}{1}
