...
\va{\tau}{are the torques of the system}{Nm}
\end{where}
...
\end{align}
\begin{where}
\va{k_{th}}{is the thrust constant found from test}{N\cdot s^2 \cdot rad^{-2}}
\va{k_d}{is the drag constant found from test}{N \cdot m\cdot s^2 \cdot rad^{-2}}
\end{where}
