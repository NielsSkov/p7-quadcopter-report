...
%
\begin{where}
    \va{\ddot{x}_I} {is the translational acceleration in the $x_I$ direction}        {m \  s^{-2} }
    \va{\ddot{y}_I} {is the translational acceleration in the $y_I$ direction}        {m \  s^{-2} }
    \va{\ddot{z}_I} {is the translational acceleration in the $z_I$ direction}        {m \  s^{-2} }
