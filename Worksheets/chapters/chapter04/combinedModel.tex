...
The mass and the length are measured directly on the system, the three inertias are calculated analytically and the constants are found through tests (\autoref{app:ThrustTest} and \ref{app:TorqueTest}).
