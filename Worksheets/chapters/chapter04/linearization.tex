...
%
\begin{flalign}
	m \overline{\ddot{z}}_I &= F_g-k_{th} ({\overline{\omega}_1}^2+{\overline{\omega}_2}^2+{\overline{\omega}_3}^2+{\overline{\omega}_4}^2) \cos\overline{\phi} \cos\overline{\theta}
\end{flalign}
...
\begin{flalign}
  ...
  m \Delta\ddot{z}_I &= -2 k_{th} \overline{\omega}_1 \Delta\omega_1 -2 k_{th} \overline{\omega}_2 \Delta\omega_2 -2 k_{th} \overline{\omega}_3 \Delta\omega_3-2 k_{th} \overline{\omega}_4 \Delta\omega_4 \label{eq:TransLinearEquations3}
\end{flalign} 
%
\begin{where}
  \va{\Delta\ddot{x_I}  }{ is the change in linear acceleration from equilibrium in $x_I$ direction }{ m \  s^{-2}}
  \va{\Delta\ddot{y_I}  }{ is the change in linear acceleration from equilibrium in $y_I$ direction }{ m \  s^{-2} }
  \va{\Delta\ddot{z_I}  }{ is the change in linear acceleration from equilibrium in $z_I$ direction }{ m \  s^{-2} }
