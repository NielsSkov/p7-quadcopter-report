...
%    \only<1>{
%        \begin{figure}[H]
%            \includegraphics[width=0.6\textwidth]{figures/dronediagram9}
%        \end{figure}            
%    }
%    \only<2>{
%        \begin{figure}[H]
%            \includegraphics[width=0.6\textwidth]{figures/dronediagram10}
%        \end{figure}            
%    }
%    \only<3>{
%        \begin{figure}[H]
%            \includegraphics[width=0.6\textwidth]{figures/dronediagram11}
%        \end{figure}            
%    }
%    \only<4>{
%        \begin{figure}[H]
...
%    \only<5>{
%        \begin{figure}[H]
%            \includegraphics[width=0.6\textwidth]{figures/dronediagram12}
%        \end{figure}            
%    }
%    \only<6>{
%        \begin{figure}[H]
%            \includegraphics[width=0.6\textwidth]{figures/dronediagram13}
%        \end{figure}            
%    }
\end{frame}
