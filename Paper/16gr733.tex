...
\author{\IEEEauthorblockN{Alejandro Alonso García, Amalie V. Petersen, Andrea Victoria Tram Løvemærke,\\Niels Skov Vestergaard, Noelia Villarmarzo Arruñada}
\IEEEauthorblockA{School of Information and Communication Technology\\Control and Automation\\
Aalborg University\\
...
\input{content/model.tex}                   %<--subsection
\input{content/network.tex}                 %<--subsection
\input{content/control.tex}                 %<--subsection
\input{content/attitudeController.tex}      %<--subsubsection
\input{content/translationalController.tex} %<--subsubsection
