...
The attitude controller for the quadcopter has been designed using a state space representation of the system. This helps handling the coupled angular response of the quadcopter. In state space, the system looks like shown in \ref{eq:statespace}
\begin{flalign}
