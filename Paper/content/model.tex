...
\begin{figure}[H]
	...
	\caption{Forces and torques acting on the quadcopter and the positive references chosen for rotations and translations in both inertial and body coordinate frames.\fxnote{Explain symbols? Change the blue colors?}}
	\label{droneDiagram}
\end{figure}
%
