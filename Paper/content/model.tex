...
\begin{flalign}
     ...
     & \ \times (\cos\phi \sin\theta \cos\psi + \sin\phi\sin\psi)   \label{eq:AccelerationEqInertial1}\nonumber\\
     m \ddot{y}_{\mathrm{I}} = &-k_{\mathrm{th}}({\omega_1}^2+{\omega_2}^2+{\omega_3}^2+{\omega_4}^2)\\
     & \ \times(\cos\phi \sin\theta \sin\psi - \sin\phi \cos\psi)  \label{eq:AccelerationEqInertial2}\nonumber\\
