...
The theoretical modeling of these influences has been studied by several researchers in order to find a maximum allowable delay and packet loss while the control system keeps stable \fxnote{THEORETICAL APPROACHES SOURCES}. However, this approach often leads to an increased complexity in the model. 
