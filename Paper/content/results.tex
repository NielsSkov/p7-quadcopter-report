...
The model parameters can be seen in \autoref{ParametersQuadcopter} . All of them have been obtained through tests except for the moments of inertia, which were calculated by following an analytical procedure. \fxnote{More details on how the parmeters were obtained and a comparison of how good is the model??}
