...
The quadcopter constitutes a control challenge due to its unstable nature and coupled behavior. It has six degrees of freedom, which are the three position coordinates and the three orientations. In addition, there are four actuation variables, namely the motor rotational speeds. \cite{draganflyer}% \fxnote{Explain "coupled" ???}\fxnote{What is the source about?}
